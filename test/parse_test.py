...
class ParseTest(unittest.TestCase):
    ...
    def test_constant_references(self):
        ...
        self.assertEqual(flat_tree.classes['b'].equations[0].right.value, 2.0)
        self.assertEqual(flat_tree.classes['b'].symbols['y'].value.value, 2.0)
        self.assertEqual(flat_tree.classes['b'].symbols['z'].value.value, 1.0)
        self.assertEqual(flat_tree.classes['b'].equations[1].right.operands[0].value, 2.0)
